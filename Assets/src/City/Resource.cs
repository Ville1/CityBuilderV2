...
public class Resource {
    ...
    public static Resource Get(ResourceType type)
    {
        if(resources == null) {
            ...
            resources.Add(ResourceType.Copper_Ore, new Resource(ResourceType.Copper_Ore, "Copper Ore", "copper_ore", SpriteManager.SpriteType.UI, 0.65f, ResourceRarity.Uncommon, new List<ResourceTag>() { ResourceTag.Mining }));
            ...
            resources.Add(ResourceType.Silver_Ore, new Resource(ResourceType.Silver_Ore, "Silver Ore", "silver_ore", SpriteManager.SpriteType.UI, 2.15f, ResourceRarity.Rare, new List<ResourceTag>() { ResourceTag.Mining, ResourceTag.Fine }));
            ...
            resources.Add(ResourceType.Gold_Ore, new Resource(ResourceType.Gold_Ore, "Gold Ore", "gold_ore", SpriteManager.SpriteType.UI, 3.40f, ResourceRarity.Very_Rare, new List<ResourceTag>() { ResourceTag.Mining, ResourceTag.Fine }));
            ...
            resources.Add(ResourceType.Gems, new Resource(ResourceType.Gold_Bars, "Gems", "gems", SpriteManager.SpriteType.UI, 10.00f, ResourceRarity.Very_Rare, new List<ResourceTag>() { ResourceTag.Mining, ResourceTag.Opulent }));
            ...
            resources.Add(ResourceType.Potatoes, new Resource(ResourceType.Potatoes, "Potatoes", "potatoes", SpriteManager.SpriteType.UI, FoodType.Vegetable, 0.70f, 0.85f, ResourceRarity.Common, new List<ResourceTag>() { ResourceTag.Agricultural, ResourceTag.Archaic, ResourceTag.Food, ResourceTag.Crop }));
            ...
            resources.Add(ResourceType.Mutton, new Resource(ResourceType.Mutton, "Mutton", "mutton", SpriteManager.SpriteType.UI, FoodType.Meat, 1.00f, 1.0f, ResourceRarity.Uncommon, new List<ResourceTag>() { ResourceTag.Agricultural, ResourceTag.Archaic, ResourceTag.Food, ResourceTag.Livestock }));
