        ...
        if (Resident_Space[Resident.Noble] != 0) {
            ...
            if (Current_Residents[Resident.Noble] != 0) {
                ...
                if (services[ServiceType.Jewelry][AMOUNT] != 0.0f) {
                    float base_jewelry_bonus = 0.10f;
